...
//    public static function getSubImageUrl($sub_image)
//    {
//        self::$imageName = $sub_image->getClientOriginalName();
//        self::$directory = 'product-images/';
...
//        self::$product->sub_image               = self::getSubImageUrl($request->file('sub_image'));
