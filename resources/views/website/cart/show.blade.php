            ...
            <div class="cart-list-head">
                ...
                <div class="cart-single-list">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-1 col-md-2 col-12">
                            <a class="remove-item" onclick="confirm('Are you sure delete this item ?')" href="{{route('remove-cart-product', ['id' => $product->id])}}"><i class="lni lni-close"></i></a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="right">
                                    <ul>
                                        ...
                                        <li>Tax Amount (15%)
                                            ...
                                            <span>{{number_format($tax)}}</span></li>
                                        <li>Shipping
                                            @php($shipping = 500)
                                            <span>{{$shipping}}</span>
                                        </li>
